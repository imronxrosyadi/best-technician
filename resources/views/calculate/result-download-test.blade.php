...
<head>
    ...
    <title>Best Technician - Report</title>
...
<div class="container">
    <div class="header-report">
        <div>
            <img src="{{ asset('img/pt-buana-express.png') }}" alt="buana-express" width="150px" height="150px">
        </div>
        <div>
            <h2>PT BUANA EXPRESS <br>Pergudangan Elang Laut</h2>
            <h4>Jl. Elang Laut Pergudangan Sentral Industri Terpadu No.23, Kota Jakarta Utara,<br> Daerah Khusus Ibukota Jakarta 14460 Telp. +62 895-2531-5794</h4>
        </div>
    </div>
    ...
    <div class="title-report">
        <h3>LAPORAN HASIL SISTEM PENUNJANG KEPUTUSAN TEKNISI TERBAIK</h3>
    </div>
